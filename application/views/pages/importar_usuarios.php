        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="card-title">Importar Afiliadores</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>El archivo debe contener los siguientes campos: <strong>nombreapellido, email (Único), telefono, id_ciudad, fecha_ingreso (YYY-MM-DD), fecha_ultimabaja (YYY-MM-DD), registradopor (id_supervisor), estado (0 => Eliminado | 1 => Activo | 99 Suspendido)</strong>.</li>
                            <li>El archivo <b>no</b> debe contener una fila de encabezado con los nombres de los campos.</li>
                        </ul>
                        <p>Descargar plantilla de ejemplo: <a href="<?= base_url('assets/files/plantilla_usuarios_afiliadores.xlsx'); ?>">plantilla_usuarios_afiliadores.xlsx</a></p>
                    </div>
...
<script>
    ...
    function sendAjaxRequest(formData) {
        return new Promise(function(resolve, reject) {
            ...
            xhr.open('POST', '<?= base_url('UsuariosController/importar_usuarios_afiliadores'); ?>', true);
            xhr.send(formData);
        });
    }
