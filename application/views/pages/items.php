              ...
              <div class="modal-dialog" style="" role="document">
                ...
                <div class="modal-content card">
                  <div class="modal-header">
                    <h5 class="modal-title font-weight-bold">Datos del Item</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-md-12 form-group">
                        <label for="categoria">Campaña:<span class="text-danger">*</span></label>
                        <select name="id_campaign" id="id_campaign" class="form-control" required>
...
<script src="<?php echo base_url();?>assets/js/pages/item.js"></script>
